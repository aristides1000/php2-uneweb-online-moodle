...
CREATE TABLE IF NOT EXISTS respuesta (
  ...
  fecha DATE,
  PRIMARY KEY(id),
  FOREIGN KEY(id_contenido) REFERENCES tema(id));

INSERT INTO tema (titulo, contenido, autor , fecha, hora) VALUES ('V.F. Corporation', 'Apparel', 'Johnna', '2024-01-30', '1:26:14'),
...
INSERT INTO respuesta (id_contenido, respuesta, autor, fecha) VALUES ('1', 'Major Banks', 'Wilhelm', '2025-01-13'),
